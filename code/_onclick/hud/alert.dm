 ...
 */
	...
	thealert.transform = matrix(0, -480, MATRIX_TRANSLATE) //would this do shit
	animate(thealert, transform = matrix(), time = 10, easing = SINE_EASING|EASE_OUT)
	//thealert.pixel_y = -480
	//animate(pixel_y = 0,time=5,loop=1,easing=SINE_EASING|EASE_OUT,flags=ANIMATION_PARALLEL)
	if(thealert.timeout)
...
/obj/screen/alert/drowning
	name = "Drowning"
	desc = "You're losing air from drowning. Get out of the water before you drown! Internals won't help you!"
	icon_state = "not_enough_oxy"
...
/obj/screen/alert/starving
	name = "Starving"
	desc = "You're severely malnourished. The hunger pains may kill you. Eat something now!"
	icon_state = "starving"
