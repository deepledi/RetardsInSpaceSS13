...
var/discordvar = "" //CHANGE THISS!!!!!!!!!!!!!!!!!!!!!!

/world/New()
	log_world("World loaded at [time_stamp()]")
	call("ByondPOST.dll", "send_post_request")("[discordvar]", " { \"content\" : \"World loaded at [time_stamp()]. Round starting soon.\" } ", "Content-Type: application/json")
	SetupExternalRSC()
...
/world/Reboot(reason = 0, fast_track = FALSE)
	...
	call("ByondPOST.dll", "send_post_request")("[discordvar]", " { \"content\" : \"Server rebooting. Round ended.\" } ", "Content-Type: application/json")
...
/world/proc/update_status()
	...
	features += "sandbox gamemode"
	features += "respawn allowed"
	features += "(american server)"

	var/s = ""

	s += "<b>RETARDS IN SPACE</b>";
	...
	for (var/mob/M in GLOB.player_list)
		if (M.client)
			n++
	features += "[n] players"
	//features += "hosted by noober84555"
