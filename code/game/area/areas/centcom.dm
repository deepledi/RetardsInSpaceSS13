...
/area/centcom/control
	name = "Fucktrasen Command Docks"

/area/centcom/evac
	name = "Fucktrasen Command Recovery Ship"

/area/centcom/supply
	name = "Fucktrasen Command Supply Shuttle Dock"

/area/centcom/ferry
	name = "Fucktrasen Command Transport Shuttle Dock"
