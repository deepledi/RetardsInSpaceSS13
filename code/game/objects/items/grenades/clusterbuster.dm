...
/obj/item/grenade/clusterbuster/preprime(mob/user, delayoverride, msg = TRUE, volume = 60)
	//var/turf/T = get_turf(src)
	playsound(loc, 'nigga.ogg', 75, 1, -3)
	user << "<font size=6>FART NIGGAS BE LIKE, OOPS I SHITTED"
