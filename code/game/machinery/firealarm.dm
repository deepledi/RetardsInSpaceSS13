#define FIREALARM_COOLDOWN 30  //osen fairly arbitrarily, it is the length of the audio in FireAlarm.ogg. The actual track length is 7 seconds 8ms but but the audio stops at 6s 700ms
...
/obj/machinery/firealarm
	name = "fire alarm"
	desc = "<i>\"fire alarm!!!!!!!!!!\"</i> run evacuate!!!"
	icon = 'icons/obj/monitors.dmi'
	icon_state = "fire0"
	anchored = TRUE
	max_integrity = 250
