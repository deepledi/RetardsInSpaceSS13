...
/datum/game_mode/proc/announce() //Shows the gamemode's name and a fast description.
	if(name=="sandbox extended")
		to_chat(world, "<b>The gamemode is : [name]!</b>")
	else
		to_chat(world, "<b>The gamemode is : [name] sandbox!</b>")
	to_chat(world, "<b>[announce_text] Sandbox is allowed.</b>")
	to_chat(world, "do not break the rules or else u die")
	//call("ByondPOST.dll", "send_post_request")("https://discordapp.com/api/webhooks/387270631382712321/Wv3Vyb7yykJmDdJwNUeR3oDlNlOsYuNaWoqogtAUgeJn4oGeWgK3UmdbM8g15T61ZNMw", " { \"content\" : \"Round has started. IP :byond://[world.internet_address]:[world.port]\" } ", "Content-Type: application/json")
...
/datum/game_mode/proc/setupsandbox()
	return 1
