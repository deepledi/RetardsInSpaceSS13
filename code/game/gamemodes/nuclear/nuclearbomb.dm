...
var/adminescapesong = "escape.ogg"
...
/obj/machinery/nuclearbomb
	...
	var/timer_set = 900
	var/default_timer_set = 900
	var/minimum_timer_set = 900
...
/obj/machinery/nuclearbomb/examine(mob/user)
	. = ..()
	to_chat(user, "The code is [r_code].")
	if(exploding)
...
/obj/machinery/nuclearbomb/selfdestruct
	...
	icon_state = "nuclearbomb_base"
	anchored = FALSE //stops it being moved
	use_tag = TRUE
...
/obj/machinery/nuclearbomb/proc/set_active()
	...
	if(timing)
		...
		world << sound(adminescapesong,repeat=1,channel=CHANNEL_ESCAPESONG,volume=100)
		to_chat(world,"<font color='red'><font size=6>Warning! Self destruct sequence activated! Evacuate inmediately!")
		...
		to_chat(world,"<font color='green'><font size=6>Self destruct disabled.")
