...
/mob/camera/blob
	...
	var/free_chem_rerolls = 10 //one free chemical reroll
...
/mob/camera/blob/Life()
	...
	if(!blob_core)
		...
		priority_announce("Biohazard has reached critical mass. Recommend mason killer involvement in lavaland.", "Biohazard Alert")
	..()


/mob/camera/blob/proc/victory()
	to_chat(world, "<B>u gay lol</B>")
