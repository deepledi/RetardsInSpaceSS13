...
/datum/game_mode/traitor
	...
	This gamemode is sandbox-allowed. You are allowed to spawn items to stop the traitors."
...
/datum/game_mode/traitor/pre_setup()
	...
	var/num_traitors = 1
	num_traitors = round(num_players()/4)
	...
	for(var/j = 0, j < num_traitors, j++)
		...
		message_admins("[traitor.key] (ckey) has been selected as a [traitor_name]")
