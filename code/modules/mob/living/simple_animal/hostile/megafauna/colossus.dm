...
/mob/living/simple_animal/hostile/megafauna/colossus
	...
	health = 999999 //5m hp lmao
	maxHealth = 999999
	attacktext = "judges"
	attack_sound = 'dab.ogg'
	icon_state = "eva"
	icon_living = "eva"
	...
	loot = list(/obj/item/fireball_staff)
...
/mob/living/simple_animal/hostile/megafauna/colossus/devour(mob/living/L)
	visible_message("<span class='colossus'>[src] dabs on [L]!</span>")
	L.gib()
...
/mob/living/simple_animal/hostile/megafauna/colossus/OpenFire()
	...
	if(enrage(target))
		if(move_to_delay == initial(move_to_delay))
			to_chat(world,"<span class='colossus'>\"<b><font color='red'>die.</b>\"</span>")
		ranged_cooldown = world.time + 1
		telegraph()
	...
	if(prob(20+anger_modifier)) //Major attack
		...
		if(health < maxHealth/3)
			double_spiral()
			to_chat(world,"<span class='colossus'>\"<b><font color='red'>DOUBLE SPIRAL!!!!!!</b>\"</span>")
		else
			to_chat(world,"<span class='colossus'>\"<b><font color='red'>SUPPER JUMP!</b>\"</span>")
			INVOKE_ASYNC(src, .proc/spiral_shoot, pick(TRUE, FALSE))
		spawn()
			for(var/mob/living/carbon/human/gay in world)
				if(gay.health > 0) //alive lol
					if(gay.z == z)
						var/dest = gay.x
						var/dest2 = gay.y
						animate(src, pixel_z = 256, time = 5)
						sleep(5)
						x = dest
						y = dest2
		...
		ranged_cooldown = world.time + 1
		random_shots()
		to_chat(world,"<span class='colossus'>\"<b><font color='red'>supper shoot! DIE!!!</b>\"</span>")
	else
		if(prob(70))
			ranged_cooldown = world.time + 1
			blast()
			to_chat(world,"<span class='colossus'>\"<b><font color='red'>BLAMMO!</b>\"</span>")
		else
			to_chat(world,"<span class='colossus'>\"<b><font color='red'>SUPER ROBUX ATTACK</b>\"</span>")
			ranged_cooldown = world.time + 1
...
/mob/living/simple_animal/hostile/megafauna/colossus/Initialize()
	...
	to_chat(world,"<span class='colossus'>\"<b><font color='red'>SUPPER NOOB HAS AWOKEN.</b>\"</span>")
...
/mob/living/simple_animal/hostile/megafauna/colossus/proc/spiral_shoot(negative = FALSE, counter_start = 8)
	...
	for(var/i in 1 to 200)
		...
		playsound(get_turf(src), 'dab.ogg', 20, 1)
