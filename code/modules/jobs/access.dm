...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT,
	            ...
	            ACCESS_SYNDICATE, ACCESS_SYNDICATE, ACCESS_AWAY_GENERIC4, ACCESS_AWAY_GENERIC3, ACCESS_AWAY_GENERIC2, ACCESS_AWAY_GENERIC1, ACCESS_AWAY_ENGINE, ACCESS_AWAY_SEC, ACCESS_AWAY_MED, ACCESS_AWAY_MAINT, ACCESS_AWAY_GENERAL,
	            ACCESS_BLOODCULT, ACCESS_CLOCKCULT)
...
/proc/get_all_jobs()
	return list("cool guys low class", "cool guys high class")
	/*, "Head of Personnel", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
				"Shaft Miner", "Clown", "Mime", "Janitor", "Curator", "Lawyer", "Chaplain", "Chief Engineer", "Station Engineer",
				"Atmospheric Technician", "Chief Medical Officer", "Medical Doctor", "Chemist", "Geneticist", "Virologist",
				"Research Director", "Scientist", "Roboticist", "Head of Security", "Warden", "Detective", "Security Officer")           mason you just got pranked fuck you*/
