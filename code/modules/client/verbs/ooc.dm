///client/verb/ooc(msg as text)
	...
	//var/keyname = key
	//to_chat(world, "<font color='[GLOB.normal_ooc_colour]'><span class='ooc'><span class='prefix'>GLOBAL OOC CHAT:</span> <EM>[keyname]:</EM> <span class='message'>[msg]</span></span></font>")
