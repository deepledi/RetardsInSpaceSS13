/client/proc/play_sound(S as sound)
	...
	var/pitch = input(usr, "What pitch would you like to play the song at?",, 1.0) as null|num
	if(!pitch)
		return
	freq = pitch
	...
	to_chat(world,"[key_name(src)] has played : [S] at [pitch]x speed")
...
/client/proc/changeescapesong(S as sound)
	set category = "Fun"
	set name = "Change Nuclear Escape Song"
	adminescapesong = S
