...
/obj/item/clothing/head/helmet/space/hardsuit/engine/elite
	...
	item_state = "ce_helm"
	item_color = "white"
	armor = list(melee = 100, bullet = 100, laser = 50, energy = 50, bomb = 50, bio = 100, rad = 100, fire = 100, acid = 100)
...
/obj/item/clothing/head/helmet/space/hardsuit/captain
	name = "GORDON RAMSAY's hardsuit helmet"
	icon_state = "capspace"
...
/obj/item/clothing/suit/space/hardsuit/captain
	name = "GORDON RAMSAY's SWAT suit"
	desc = "A MK.II SWAT suit with streamlined joints and armor made out of superior materials, insulated against intense heat. The most advanced tactical armor available Usually reserved for heavy hitter corporate security, this one has a regal finish in FUCKtrasen company colors. Better not let the assistants get a hold of it."
	icon_state = "caparmor"
