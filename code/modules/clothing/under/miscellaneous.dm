...
/obj/item/clothing/under/rank/centcom_officer
	desc = "It's a jumpsuit worn by Fucktrasen Command Officers."
	name = "\improper Fucktrasen Command officer's jumpsuit"
	icon_state = "officer"
	item_state = "g_suit"
	item_color = "officer"
	alt_covers_chest = 1
...
/obj/item/clothing/under/rank/centcom_commander
	desc = "It's a jumpsuit worn by Fucktrasen Command's highest-tier Commanders."
	name = "\improper Fucktrasen Command officer's jumpsuit"
	icon_state = "centcom"
	item_state = "dg_suit"
	item_color = "centcom"
